...
const { Mensaje, Sala, Usuario } = models;

import { generarCodigoUnico } from '../helpers/generar-aleatorio.js';
import _ from 'lodash';
// const { obtenerUsuariosSalaHelper } = require("../helpers/obtener-usuario");

export const obtenerMensajesSala = async (req, res) => {
...
export const unirseSala = async (req, res) => {
...
export const grabarMensajeSala = async (req, res) => {
  try {
...
*/
export const obtenerUsuariosSalaHelper = async (salaId) => {
  try {
...
export const cambiarEstadoSala = async (req, res) => {
  try {
...
export const obtenerSalasConMensajesNoLeidos = async (req, res) => {
  const usuarioId = req.uid;
...
export const obtenerSalasMensajesUsuario = async (req, res) => {
  const uid = req.uid;
...
export const getSalasByUser = async (req, res) => {
  const uid = req.uid;
  try {
    const salas = await Sala.find(
...
export const getMensajesBySala = async (req, res) => {
...
export const getMensajesSala = async (req, res) => {
  try {
    const { salaId } = req.params;
...
export const obtenerUsuariosSala = async (req, res) => {
  const { salaId } = req.params;
  try {
...
export const abandonarSala = async (req, res) => {
  const { salaId } = req.params;
  const uid = req.uid;
