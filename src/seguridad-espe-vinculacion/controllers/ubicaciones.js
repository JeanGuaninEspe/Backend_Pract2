...
const { Ubicacion, Usuario } = models;

export const crearUbicacion = async (req, res = response) => {
  try {
...
export const obtenerUbicaciones = async (req, res = response) => {
  try {
...
export const obtenerUbicacionesPorUsuario = async (req, res = response) => {
...
export const agregarUbicacion = async (req, res = response) => {
  const usuarioId = req.uid;
...
export const eliminarUbicacion = async (req, res = response) => {
  const usuarioId = req.uid;
  const ubicacionId = req.params.id;
