...
export const obtenerUnidadesEducativas = async (req, res) => {
...
export const obtenerBarrios = async (req, res) => {
  let barrios = [];
  let consulta = {};
  try {
...
export const obtenerDatosCards = async (req, res) => {
  try {
...
export const obtenerDatosCardsF3 = async (req, res) => {
  try {
...
export const convertToEcuadorTimeZone = (date) => {
...
export const obtenerReporteBarras = async (req, res) => {
  let emergencias = [];
  let consulta = {};
  try {
    const parametrosBusqueda = req.body;
...
export const obtenerReportePastel = async (req, res) => {
...
export const obtenerMapaCalor = async (req, res) => {
  let consulta = {};
  try {
    const parametrosBusqueda = req.body;
    Object.keys(parametrosBusqueda).forEach(key => {
...
export const   descargarXLSX = async (req, res) => {
  let consulta = {};
  try {
    const parametrosBusqueda = req.body;
    Object.keys(parametrosBusqueda).forEach((key) => {
...
// Función para exportar un array de objetos a Excel
export async function exportToCSV(dataArray) {
  const workbook = new ExcelJS.Workbook();
  const worksheet = workbook.addWorksheet('Reporte_IncidentesUE');
